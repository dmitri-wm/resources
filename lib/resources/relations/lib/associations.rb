    ...
    module Adapters
      module Lib
        module Associations
          ...
          included do
            mstore :associations, key: :name, unique: true
          ...
          class_methods do
            ...
            def define_association(type, name, options)
              Association.new(source: self, name:, type:,
            ...
            def store_association_config =->(c) { c.tap { associations << c } }
          end
          ...
          def to_association
            ->(config) { Entities::AssociationEntity.new(config:, parent: self) }
          end
