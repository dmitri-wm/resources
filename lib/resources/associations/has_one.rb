...
module Resources
  module Associations
    # Represents a has_one association between resources
    class HasOne < BelongsTo
      # @note This method is not implemented in the HasOne class
      ...
      # @example
      #   has_one.associate({name: 'Post'}, {id: 1, name: 'User'}) #=> {name: 'Post', user_id: 1}
